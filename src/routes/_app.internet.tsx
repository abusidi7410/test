...
const providers = [
  ...
  { name: "Smile", value: "smile", color: "#F26522" },
  { name: "Swift", value: "swift", color: "#0EA5E9" },
  { name: "Tizeti", value: "tizeti", color: "#059669" },
];
...
function InternetPage() {
  ...
  const form = useForm<InternetInput>({
    ...
    defaultValues: { provider: "", customer_id: "", plan: "" },
  });
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Your ISP account ID" className="h-11" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={() => (
                        <FormItem>
                          ...
                          <Select
                            ...
                            value={selectedPlan}
                            onValueChange={(v) =>
                              form.setValue("plan", v, { shouldValidate: true })
                            }
                          >
                            <FormControl>
