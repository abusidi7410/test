...
function AirtimePage() {
  ...
  return (
    <div>
      <PageHeader
        title="Buy airtime"
        description="Instant airtime top-ups at discounted rates on all networks."
      />
        ...
        >
          <Card>
            <CardContent className="p-6">
              ...
              <h3 className="text-base font-semibold">About Buy Airtime</h3>
              <p className="mt-1 text-sm text-muted-foreground">
                Instant airtime top-ups at discounted rates on all networks.
              </p>
