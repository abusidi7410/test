...
const providers = [
  ...
  { name: "SportyBet", value: "sportybet", color: "#E4002B" },
  { name: "1xBet", value: "1xbet", color: "#0EA5E9" },
  { name: "BetKing", value: "betking", color: "#111827" },
];
...
function BettingPage() {
  ...
  const form = useForm<BettingInput>({
    ...
    defaultValues: { provider: "", user_id: "", amount: undefined },
  });
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="Your bookmaker user ID"
                              className="h-11"
                              {...field}
                            />
                          </FormControl>
